...
// Obtener el puerto de Render (importante: Render asigna su propio puerto)
const PORT = process.env.PORT || 10000

// Configuración CORS específica para tu dominio de Vercel
const corsOrigins = [
  "https://pianoparty2.vercel.app", // Tu URL específica de Vercel
  "http://localhost:3000", // Para desarrollo local
  /\.vercel\.app$/, // Para cualquier preview de Vercel
]
...
// Crear servidor HTTP con endpoint de health check para Render
const httpServer = createServer((req, res) => {
  // Agregar headers CORS para las solicitudes HTTP
  ...
  if (req.url === "/" || req.url === "/health") {
    ...
    res.end(
      JSON.stringify({
        ...
        message: "Piano Party Backend is running!",
      }),
    )
    return
  }
...
// Configurar Socket.IO con configuración optimizada para Render
...
httpServer.listen(PORT, () => {
  ...
  console.log(`🎹 Piano Party Backend - Render Edition!`)
})
